...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 03, 2019 at 03:27 AM
...
INSERT INTO `customer` (`CustomerID`, `CustomerName`, `CustomerPNumber`, `CustomerEmail`, `DateCreate`) VALUES
('CT001', 'Josh Doe', '081495275645', 'josh.doe@gmail.com', '0000-00-00'),
('CT002', 'Jack Doe', '0897785621354', 'jack.doe@gmail.com', '0000-00-00');
...
('IT001', 'Shock Breaker', 'Radius: 20 mm. Length: 20 cm.', 20, 800000),
('IT002', 'Barang1', 'barang1', 16, 100000);
...
INSERT INTO `purchase_detail` (`PurchaseID`, `ItemID`, `Quantitiy`) VALUES
('PC001', 'IT002', 30);
...
INSERT INTO `sales_detail` (`WOID`, `ItemID`, `Quantity`) VALUES
('WO001', 'IT001', 2);
...
INSERT INTO `staff` (`StaffID`, `STypeID`, `StaffName`, `StaffPNumber`, `StaffEmail`, `StaffDOB`, `StaffPassword`, `StaffSalary`, `img`) VALUES
('ST001', 'TP001', 'John Doe', '08132465795', 'john.doe@gmail.com', '1985-12-13', 'johndoe', 5000000, 'davatar.png'),
('ST002', 'TP002', 'Jane Doe', '08135794168544', 'jane.doe@gmail.com', '1985-03-05', 'janedoe', 3000000, '1.jpg'),
('ST003', 'TP001', '1', '123', '123@gmail.com', '1998-02-11', '123', 1000000, 'download.png');
...
('VH003', 'CT001', 'VT001', 'lol'),
('VH005', 'CT002', 'VT002', 'motor metah');
...
CREATE TABLE `vendor` (
  ...
  `VendorPICPNumber` varchar(15) NOT NULL,
...
INSERT INTO `work_order` (`WOID`, `VehicleID`, `WODateTime`, `OrderDescription`, `stat`) VALUES
('WO001', 'VH003', '2018-12-22 00:00:00', '123', 'OnProgress'),
('WO002', 'VH002', '2019-01-01 00:00:00', 'lel', 'OnProgress'),
('WO003', 'VH005', '2019-01-01 00:00:00', 'lel3', 'OnProgress');
...
INSERT INTO `wo_detail` (`StaffID`, `WOID`) VALUES
('ST002', 'WO002'),
('ST002', 'WO003'),
('ST003', 'WO001');
